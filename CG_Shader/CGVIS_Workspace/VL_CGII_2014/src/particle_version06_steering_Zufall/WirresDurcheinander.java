package particle_version06_steering_Zufall;
...
public class WirresDurcheinander extends BasisFenster {
   private ObjektManager flummies;
   
   public WirresDurcheinander() {
